...
function lib_channel(&$ctag,&$refObj)
{
    ...
    if($type=='top')
    {
        $sql = "SELECT id,typename,typedir,isdefault,typeimg,description,ispart,defaultname,namerule2,moresite,siteurl,sitepath
          From `#@__arctype` WHERE reid=0 And ishidden<>1 order by sortrank asc limit 0, $line ";
    }
    else if($type=='son')
    {
        if($typeid==0) return '';
        $sql = "SELECT id,typename,typedir,isdefault,typeimg,ispart,description,defaultname,namerule2,moresite,siteurl,sitepath
    ...
    {
        $sql = "SELECT id,typename,typedir,isdefault,ispart,typeimg,description,defaultname,namerule2,moresite,siteurl,sitepath
            FROM `#@__arctype` WHERE reid='$reid' And ishidden<>1 order by sortrank asc limit 0, $line ";
        $dsql->SetQuery($sql);
      $dsql->Execute();
    }
