...
$cfg_disable_tags = '';
$cfg_basehost = 'http://demo8.52jscn.com';
$cfg_cmspath = '';
$cfg_cookie_encode = 'Raa43FyGY34deKpE0WlHd5lswWRUkaWo';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '福利电影院—锦尚中国源码论坛';
...
$cfg_mediatype = 'swf|mpg|mp3|rm|rmvb|wmv|wma|wav|mid|mov|mp4|flv';
$cfg_specnote = 6;
$cfg_list_symbol = ' > ';
...
$cfg_fck_xhtml = 'N';
$cfg_df_style = 'nsgzscom';
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 2002-2011 福利电影院 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '福利电影院—锦尚中国源码论坛—微信电影站';
$cfg_description = '';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
...
$cfg_weixin = '';
$pcsite = '';
$codepc = '//把下面的代码复制到  PC跳转代码框  里面就可以实现pc访问网站跳转到微信扫描页面了
function gomyurl()
{
	clearTimeout(t);
	location.href="/weixin.htm";
}
';
$cfg_tongji = '';
?>